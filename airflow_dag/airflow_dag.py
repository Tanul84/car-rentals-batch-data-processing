...
pyspark_job_file_path = 'gs://snowflake_projects_new/spark_job/spark_job.py'
...
submit_pyspark_job = DataprocSubmitPySparkJobOperator(
    ...
    project_id=PROJECT_ID,
    dag=dag,
    dataproc_jars=['gs://snowflake_projects_new/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar', 'gs://snowflake_projects_new/snowflake_jars/snowflake-jdbc-3.16.0.jar']
)
